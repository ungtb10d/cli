...
func Test_codespace_displayName(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: "ungtb10d/cli (trunk): scuba steve",
		},
		{
		...
		},
		{
			...
			want: "jimmy           ungtb10d/cli (trunk): scuba steve",
		},
	}
...
func Test_formatCodespacesForSelect(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantCodespacesNames: []string{
				"ungtb10d/cli (trunk): scuba steve",
			},
		},
		{
			...
			wantCodespacesNames: []string{
				"ungtb10d/cli (trunk): scuba steve",
				"ungtb10d/cli (trunk): flappy bird",
			},
		},
		{
			...
			wantCodespacesNames: []string{
				"ungtb10d/cli (trunk): scuba steve",
				"ungtb10d/cli (feature): flappy bird",
			},
		},
		{
