...
func newCmdClone(f *cmdutil.Factory, runF func(*cloneOptions) error) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		`),
		Example: heredoc.Doc(`
			# clone and overwrite labels from ungtb10d/cli repository into the current repository
			$ gh label clone ungtb10d/cli --force

			# clone labels from ungtb10d/cli repository into a octocat/cli repository
			$ gh label clone ungtb10d/cli --repo octocat/cli
		`),
