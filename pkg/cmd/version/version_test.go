...
func TestFormat(t *testing.T) {
	expects := "gh version 1.4.0 (2020-12-15)\nhttps://github.com/ungtb10d/cli/releases/tag/v1.4.0\n"
...
func TestChangelogURL(t *testing.T) {
	tag := "0.3.2"
	url := "https://github.com/ungtb10d/cli/releases/tag/v0.3.2"
	...
	tag = "0.3.2-pre.1"
	url = "https://github.com/ungtb10d/cli/releases/tag/v0.3.2-pre.1"
	result = changelogURL(tag)
	if result != url {
		t.Errorf("expected %s to create url %s but got %s", tag, url, result)
	}
	...
	url = "https://github.com/ungtb10d/cli/releases/latest"
	result = changelogURL(tag)
	if result != url {
		t.Errorf("expected %s to create url %s but got %s", tag, url, result)
	}
